...
public class DownloadRandomAccessFile extends RandomAccessFile 
{
     ...
     */
    public DownloadRandomAccessFile(String name, String mode) throws IOException
    {
        this(new File(name), mode, DEFAULT_BUFFER_SIZE);
    }

    public DownloadRandomAccessFile(String name, String mode, int bufferSize) throws IOException
    {
     ...
     * reading and writing.
     */
    public DownloadRandomAccessFile(File file, String mode) throws IOException
    {
        this(file, mode, DEFAULT_BUFFER_SIZE);
    }

    public DownloadRandomAccessFile(File file, String mode, int bufferSize) throws IOException
    {
        this(file, mode, bufferSize, false);
    }

    public DownloadRandomAccessFile(File file, String mode, int bufferSize, boolean skipCache) throws IOException
    {
        super(file, mode);
...
//        }
    ...
    public static DownloadRandomAccessFile getUncachingReader(String filename) throws IOException
    {
        return new DownloadRandomAccessFile(new File(filename), "r", 8 * 1024 * 1024, true);
    }
